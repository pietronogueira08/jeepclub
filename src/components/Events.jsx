    ...
    <AnimatePresence>
      ...
      >
        <motion.div
          ...
          className="relative bg-brand-surface border border-white/10 rounded-xl w-full mx-3 sm:mx-4 max-w-2xl max-h-[92vh] overflow-y-auto overscroll-contain"
        >
          {/* Header image */}
          <div className="relative h-40 sm:h-48 overflow-hidden rounded-t-xl flex-shrink-0">
            <img
              src={event.image}
              alt={event.name}
            ...
            <button
              onClick={onClose}
              className="absolute top-3 right-3 w-8 h-8 rounded-full bg-black/60 flex items-center justify-center text-brand-muted hover:text-brand-text transition-colors"
            >
              <X size={16} />
            </button>
          ...
          <div className="p-4 sm:p-6 space-y-4 sm:space-y-5">
            <div>
              <h3 className="font-display text-brand-text text-xl sm:text-2xl mb-1">{event.name}</h3>
              <div className="flex flex-wrap gap-3 text-xs sm:text-sm font-mono text-brand-muted">
            ...
            {/* Meet info */}
            <div className="bg-brand-bg rounded-lg p-3 sm:p-4 space-y-2 text-xs sm:text-sm font-mono">
            ...
            <a
              ...
              className="flex items-center justify-center gap-2 w-full py-3.5 bg-brand-primary hover:bg-brand-accent text-white font-display tracking-widest text-sm sm:text-base rounded-lg transition-colors glow-orange"
            >
...
export default function Events() {
  ...
  return (
    <section
      id="eventos"
      className="relative bg-brand-surface py-20 sm:py-24 lg:py-32"
    >
      {/* Background pattern */}
      <div
          ...
          {EVENTS.map((event, i) => {
            ...
            return (
              <motion.article
                ...
                whileHover={{ y: -4 }}
                className="group bg-brand-bg border border-white/5 hover:border-brand-primary/30 rounded-xl overflow-hidden transition-all duration-300 cursor-pointer flex flex-col active:scale-[0.98]"
              ...
              >
                ...
                <div className="p-4 sm:p-5 flex flex-col flex-1 gap-3">
                  ...
                  <button className="flex items-center justify-center gap-2 w-full mt-1 py-3 border border-brand-primary/40 hover:bg-brand-primary hover:border-brand-primary text-brand-primary hover:text-white font-body font-semibold text-sm rounded-lg transition-all duration-200 group-hover:border-brand-primary touch-manipulation">
                    VER DETALHES
